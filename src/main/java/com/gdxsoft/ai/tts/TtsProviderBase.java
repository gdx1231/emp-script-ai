...
/**
 * Common scaffolding for TTS providers — config map, defaults, apiUrl/apiKey state.
 * <p>
 * Concrete providers must implement {@link #synthesize(TtsRequest)} and
 * {@link #curl(TtsRequest)}. Transport is via {@code HttpUtils.createHttpClient()}.
 *
 * @since 1.1.0
 */
public abstract class TtsProviderBase implements ITtsProvider {
    protected static final Logger LOGGER = LoggerFactory.getLogger(TtsProviderBase.class);
