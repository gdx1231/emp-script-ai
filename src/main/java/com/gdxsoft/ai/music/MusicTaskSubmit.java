 ...
 * <p>
 * 本地异步回退（{@link MusicProviderBase} 默认实现）下 taskId 为 {@code local-} 前缀，
 * 仅在本 JVM 进程内有效。
 *
 * @since 1.5.0
 */
public class MusicTaskSubmit {
    private final String taskId;
    private final JSONObject raw;

    public MusicTaskSubmit(String taskId, JSONObject raw) {
        this.taskId = taskId;
        this.raw = raw;
    }
