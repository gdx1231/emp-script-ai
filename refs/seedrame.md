...
用于生成图像的提示词，支持中英文。（查看提示词指南：[Seedream 4.0-5.0 提示词指南](https://docs.volcengine.com/docs/82379/1829186)）
...
输入的图片信息，支持 URL 或 Base64 编码。支持单图或多图输入（[查看多图融合示例](https://docs.volcengine.com/docs/82379/1824121#4a35e28f)）。
